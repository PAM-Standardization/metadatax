...
class PhysicalDescriptor(models.Model):
    ...
    label = models.OneToOneField(Label, on_delete=models.CASCADE, related_name='physical_descriptor')
    ...
    mean_duration = models.FloatField(null=True, blank=True, validators=[MinValueValidator(0),])
