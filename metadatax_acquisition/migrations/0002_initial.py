    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="metadatax_equipment.platform",
            ),
        ),
        migrations.AddField(
            model_name="deployment",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="metadatax_equipment.equipment",
                validators=[
                    metadatax_acquisition.models.channel_configuration_recorder_specification.validate_hydrophone
                ],
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="metadatax_equipment.equipment",
                validators=[
                    metadatax_acquisition.models.channel_configuration_recorder_specification.validate_recorder
                ],
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="metadatax_acquisition.channelconfiguration",
            ),
        ),
        migrations.AddField(
            model_name="channelconfigurationfiles",
            name="file",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="metadatax_data.file"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="metadatax_equipment.equipment",
                validators=[
                    metadatax_acquisition.models.channel_configuration_detector_specification.validate_detector
                ],
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="metadatax_acquisition.deployment",
            ),
        ),
        migrations.AddField(
            model_name="channelconfiguration",
            ...
            field=models.OneToOneField(
                ...
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="metadatax_acquisition.channelconfigurationdetectorspecification",
            ),
        ),
        migrations.AddField(
            model_name="channelconfiguration",
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name="channel_configurations",
                through="metadatax_acquisition.ChannelConfigurationFiles",
                to="metadatax_data.File",
            ),
        ),
        migrations.AddField(
            model_name="channelconfiguration",
            ...
            field=models.ManyToManyField(
                blank=True, to="metadatax_equipment.Equipment"
            ),
        ),
        migrations.AddField(
            model_name="channelconfiguration",
            ...
            field=models.OneToOneField(
                ...
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="metadatax_acquisition.channelconfigurationrecorderspecification",
            ),
        ),
        migrations.AddField(
            model_name="campaign",
