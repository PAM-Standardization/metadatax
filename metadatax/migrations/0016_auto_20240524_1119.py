...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='file',
            name='file_size',
            field=models.BigIntegerField(blank=True, help_text='Total number of bytes of the audio file (in bytes).',
                                         null=True),
        ),
        migrations.AlterField(
            model_name='campaign',
            name='name',
            field=models.CharField(help_text='Name of the campaign during which the instrument was deployed.',
                                   max_length=255),
        ),
        migrations.AlterField(
            model_name='campaign',
            name='project',
            field=models.ForeignKey(help_text='Project associated to this campaign',
                                    on_delete=django.db.models.deletion.CASCADE, related_name='campaigns',
                                    to='metadatax.project'),
        ),
        migrations.AlterField(
            model_name='channelconfiguration',
            name='channel_name',
            field=models.CharField(blank=True, default='A', help_text='Name of the channel used for recording.',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(blank=True, help_text='Immersion depth of hydrophone (in positive meters).',
                                      null=True, validators=[django.core.validators.MinValueValidator(0)]),
        ),
        migrations.AlterField(
            model_name='channelconfiguration',
            name='recording_format',
            field=models.ForeignKey(blank=True, help_text='Format of the recorded files', null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='metadatax.fileformat'),
        ),
        migrations.AlterField(
            model_name='channelconfiguration',
            name='sample_depth',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(help_text='Sampling frequency of the recording channel (in Hertz).',
                                      validators=[django.core.validators.MinValueValidator(0)]),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='deployment',
            name='campaign',
            field=models.ForeignKey(blank=True, help_text='Campaign during which the instrument was deployed.',
                                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deployments',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, help_text='Name of the vehicle associated with the deployment.',
        ...
        migrations.AlterField(
            model_name='deployment',
            name='latitude',
            field=models.FloatField(help_text='Latitude of the platform position (WGS84 decimal degrees).'),
        ),
        migrations.AlterField(
            model_name='deployment',
            name='longitude',
            field=models.FloatField(help_text='Longitude of the platform position (WGS84 decimal degree).'),
        ),
        migrations.AlterField(
            model_name='deployment',
            name='name',
            field=models.CharField(blank=True, help_text='Name of the deployment.', max_length=255, null=True),
        ),
        migrations.AlterField(
            model_name='deployment',
            name='platform',
            field=models.ForeignKey(blank=True, help_text='Support of the deployed instruments', null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, related_name='deployments',
                                    to='metadatax.platform'),
        ),
        migrations.AlterField(
            model_name='deployment',
            name='project',
            field=models.ForeignKey(help_text='Project associated to this deployment',
                                    on_delete=django.db.models.deletion.CASCADE, related_name='deployments',
                                    to='metadatax.project'),
        ),
        migrations.AlterField(
            model_name='deployment',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, help_text='Name of the vehicle associated with the recovery.',
                                   max_length=255, null=True),
        ),
        migrations.AlterField(
            model_name='deployment',
        ...
        migrations.AlterField(
            ...
            name='contact',
            field=models.EmailField(blank=True, help_text='Contact email of the manufacturer', max_length=254,
                                    null=True),
        ),
        migrations.AlterField(
            model_name='equipmentprovider',
            name='name',
            field=models.CharField(help_text='Name of the manufacturer', max_length=255, unique=True),
        ),
        migrations.AlterField(
            model_name='equipmentprovider',
            name='website',
            field=models.URLField(blank=True, help_text='Website of the manufacturer', null=True),
        ),
        migrations.AlterField(
            model_name='file',
            name='accessibility',
            field=models.TextField(blank=True,
                                   choices=[('C', 'Confidential'), ('R', 'Upon request'), ('O', 'Open access')],
                                   default='R',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(help_text='Channel configuration related to this file',
                                    on_delete=django.db.models.deletion.CASCADE, to='metadatax.channelconfiguration'),
        ),
        migrations.AlterField(
            model_name='file',
            name='duration',
            field=models.IntegerField(blank=True, help_text='Duration of the audio file (in seconds).', null=True,
                                      validators=[django.core.validators.MinValueValidator(0)]),
        ),
        migrations.AlterField(
            model_name='file',
            name='format',
            field=models.ForeignKey(blank=True, help_text='Format of the audio file.', null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='metadatax.fileformat'),
        ),
        migrations.AlterField(
            model_name='file',
            name='initial_timestamp',
            field=models.DateTimeField(blank=True, help_text='Date and time of the audio file start (in UTC).',
                                       null=True),
        ),
        migrations.AlterField(
            model_name='file',
            name='name',
            field=models.CharField(help_text='Name of the audio file, with extension.', max_length=255),
        ),
        migrations.AlterField(
            model_name='file',
            name='sample_depth',
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True, help_text='Description of the path to access the data.', null=True),
        ),
        migrations.AlterField(
            model_name='fileformat',
            name='name',
            field=models.CharField(help_text='Format of the audio file (eg: wav, flac...)', max_length=20),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='hydrophone',
            name='model',
            field=models.ForeignKey(help_text='Model of the hydrophone', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='hydrophone_items', to='metadatax.hydrophonemodel'),
        ),
        migrations.AlterField(
            model_name='hydrophone',
            name='noise_floor',
        ...
        migrations.AlterField(
            model_name='hydrophone',
            name='serial_number',
            field=models.CharField(help_text='Serial number of the hydrophone', max_length=255),
        ),
        migrations.AlterField(
            model_name='hydrophonemodel',
            name='directivity',
            field=models.TextField(blank=True, choices=[('OMNI', 'Omni-directional'), ('BI', 'Bi-directional'),
                                                        ('UNI', 'Uni-directional'), ('CAR', 'Cardioid'),
                                                        ('SCAR', 'Supercardioid')],
                                   help_text='Directivity of the hydrophone', null=True),
        ),
        migrations.AlterField(
            model_name='hydrophonemodel',
            name='name',
            field=models.CharField(help_text='Name of the hydrophone model.', max_length=255),
        ),
        migrations.AlterField(
            model_name='hydrophonemodel',
        ...
        migrations.AlterField(
            model_name='hydrophonemodel',
            name='provider',
            field=models.ForeignKey(help_text='Hydrophone manufacturer.', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='hydrophone_models', to='metadatax.equipmentprovider'),
        ),
        migrations.AlterField(
            model_name='institution',
            name='contact',
            field=models.EmailField(help_text='Generic and permanent email address', max_length=254),
        ),
        migrations.AlterField(
            model_name='institution',
            name='name',
        ...
        migrations.AlterField(
            model_name='institution',
            name='website',
            field=models.URLField(blank=True, help_text='If exists, the website URL of the institution', null=True),
        ),
        migrations.AlterField(
            model_name='platform',
            name='description',
            field=models.TextField(blank=True, help_text='Optional description of the platform.', null=True),
        ),
        migrations.AlterField(
            model_name='platform',
            name='name',
            field=models.CharField(help_text='Name of the specific support of the deployed instruments',
                                   max_length=255),
        ),
        migrations.AlterField(
            model_name='platform',
            name='type',
            field=models.ForeignKey(blank=True, help_text='Generic type of support', null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, related_name='platforms',
        ...
        migrations.AlterField(
            model_name='project',
            name='doi',
            field=models.CharField(blank=True, help_text='Digital Object Identifier of the data, if existing.',
                                   max_length=255, null=True),
        ),
        migrations.AlterField(
            model_name='project',
        ...
        migrations.AlterField(
            model_name='project',
            name='project_goal',
            field=models.TextField(blank=True, help_text='Description of the goal of the project.', null=True),
        ),
        migrations.AlterField(
            model_name='project',
            name='project_type',
            field=models.ForeignKey(blank=True,
                                    ...
                                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects',
        ...
        migrations.AlterField(
            model_name='recorder',
            name='model',
            field=models.ForeignKey(help_text='Model of the recorder', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='recorder_items', to='metadatax.recordermodel'),
        ),
        migrations.AlterField(
            model_name='recorder',
            name='serial_number',
            field=models.CharField(help_text='Serial number of the recorder', max_length=255),
        ),
        migrations.AlterField(
            model_name='recordermodel',
            name='name',
            field=models.CharField(help_text='Name of the recorder model.', max_length=255),
        ),
        migrations.AlterField(
            model_name='recordermodel',
        ...
        migrations.AlterField(
            model_name='recordermodel',
            name='provider',
            field=models.ForeignKey(help_text='Recorder manufacturer.', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='recorder_models', to='metadatax.equipmentprovider'),
        ),
        migrations.AlterField(
            model_name='site',
            name='name',
        ...
        migrations.AlterField(
            model_name='site',
            name='project',
            field=models.ForeignKey(help_text='Project associated to this site',
                                    on_delete=django.db.models.deletion.CASCADE, related_name='sites',
                                    to='metadatax.project'),
        ),
