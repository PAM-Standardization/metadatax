...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "metadatax_data_audioproperties"},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "metadatax_data_detectionproperties"},
        ),
        migrations.CreateModel(
            name="FileFormat",
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Format of the file", max_length=20),
                ),
            ],
            options={"db_table": "metadatax_data_fileformat"},
        ),
        migrations.CreateModel(
            name="File",
            fields=[
                ...
                (
                    "filename",
                    models.CharField(
                        help_text="Name of the file, with extension.", max_length=255
                    ),
                ),
                (
                    "storage_location",
            ...
            options={"db_table": "metadatax_data_file"},
        ),
    ]
